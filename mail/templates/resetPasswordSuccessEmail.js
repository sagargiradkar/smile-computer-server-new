...
exports.resetPasswordSuccessEmail = (userName) => {
  return `<!DOCTYPE html>
    <html>
    <head>
        <meta charset="UTF-8">
        <title>Password Reset Successful - Smile Computer Education</title>
    ...
    <body>
        <div class="email-container">
            ...
            <div class="content">
                ...
                <a class="button" href="https://smilecomputereducation.com/login">Login Now</a>
