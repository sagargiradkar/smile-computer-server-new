...
exports.resetPasswordEmail = (resetLink, userName) => {
  return `<!DOCTYPE html>
    <html>
    <head>
        <meta charset="UTF-8">
        <title>Password Reset - Smile Computer Education</title>
    ...
    <body>
        <div class="email-container">
            ...
            <div class="content">
                ...
                <p>For any issues, feel free to reach out to our support team.</p>
            </div>
            <div class="footer">
